var main = new Vue({
    ...
    created() {
        ...
        this.statistics = {
            ...
            least_loyal_names: this.getFullname(this.getTenPercentOfVoters("lowest")),
            least_loyal_number_of_votes: this.getTotalCountOfVotes(this.getTenPercentOfVoters("lowest")),
            least_loyal_percentage_party_votes: this.getPartyPercentage(this.getTenPercentOfVoters("lowest")),
